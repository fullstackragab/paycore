    ...
    <div style={{ maxWidth: 1100, width: "100%" }}>
      <div style={{ marginBottom: 24 }}>
        ...
        <p style={{ fontSize: 12, color: "#6b7280", margin: 0 }}>
          Simulate a card payment at a supermarket terminal. Watch the ISO 8583
          authorization flow in real time.
        </p>
      </div>
              ...
              {[true, false].map((v) => (
                <button
                  ...
                  style={{
                    ...
                    cursor: "pointer",
                    borderColor:
                      form.isContactless === v ? "#111827" : "#e5e7eb",
          ...
          {stages.length === 0 && !processing ? (
            ...
            >
              ...
              <p style={{ fontSize: 13, color: "#9ca3af", margin: 0 }}>
                Fill in the payment details and click Pay to see the full
                authorization flow
              </p>
            </div>
          ) : (
