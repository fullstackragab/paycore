    ...
    <div style={{ maxWidth: 1100, width: "100%" }}>
      <div style={{ marginBottom: 24 }}>
        ...
        <p style={{ fontSize: 12, color: "#6b7280", margin: 0 }}>
          Insert card, enter PIN, withdraw cash. See PIN encryption, balance
          check, auth hold, and ledger entries.
        </p>
      </div>
        ...
        >
            ...
            {ATM_LOCATIONS.map((a) => (
              <button
                ...
                style={{
                  ...
                  background: atm.id === a.id ? "#f9fafb" : "#fff",
                  color: "#374151",
                }}
              >
                {a.location}
            ...
            <div key={f.key}>
              ...
              <input
                ...
                style={{
                  ...
                  letterSpacing: f.key === "pin" ? "0.3em" : "normal",
                }}
              />
            </div>
          ))}
          ...
          >
            <p style={{ fontSize: 11, color: "#92400e", margin: 0 }}>
              ⚠ ATM surcharge: $2.50 for foreign card withdrawals
            </p>
          </div>
          ...
          {result && (
            ...
            >
              ...
              {result.approved && result.totalDebited && (
                ...
                >
                  Total debited: ${(result.totalDebited / 100).toFixed(2)}{" "}
                  (incl. ${(result.atmFee! / 100).toFixed(2)} fee)
                </p>
              )}
              {result.authCode && (
                <p
          ...
          {stages.length === 0 && !processing ? (
            ...
            >
              ...
              <p style={{ fontSize: 13, color: "#9ca3af", margin: 0 }}>
                Select an ATM, insert your card, enter PIN and amount to see the
                full ATM authorization flow
              </p>
            </div>
          ) : (
            <StageWizard
