    ...
    <div style={{ maxWidth: 1100, width: "100%" }}>
      <div style={{ marginBottom: 24 }}>
        ...
        <p style={{ fontSize: 12, color: "#6b7280", margin: 0 }}>
          Card-not-present payment with tokenization and 3-D Secure. Watch what
          happens behind the checkout form.
        </p>
      </div>
            ...
            {PRODUCTS.map((p) => (
              <button
                ...
                style={{
                  ...
                  background: product.name === p.name ? "#f9fafb" : "#fff",
                  color: "#374151",
                }}
              >
            ...
            <div key={f.key}>
              ...
              <input
                ...
                style={{
                  ...
                  border: "1px solid #e5e7eb",
                  borderRadius: 4,
                  fontFamily: ["pan", "cvv"].includes(f.key)
                    ? "monospace"
                    : "inherit",
          ...
          {stages.length === 0 && !processing ? (
            ...
            >
              ...
              <p style={{ fontSize: 13, color: "#9ca3af", margin: 0 }}>
                Select a product and click Pay to see tokenization, 3DS, and
                authorization
              </p>
            </div>
          ) : (
